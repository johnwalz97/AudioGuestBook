...
AudioConnection patchCord2(playWav1, 0, i2sOutput, 0);
...
// continue recording (pushing data from mic to sd card)
...
// stop recording (close buffer and file)
void stopRecording()
{
...
// play all recordings in the SD card
...
void loop()
{
  ...
  {
    Serial.println("greeting.wav not found");
  }
